      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md p-6 sm:p-10 bg-white border border-gray-200">
          ...
          <button
            ...
            onClick={() => googleLogin()}
            disabled={isLoading}
            className="w-full py-3 px-4 bg-gray-50 hover:bg-gray-100 border border-gray-200 text-gray-800 font-medium text-sm flex items-center justify-center gap-3 transition-all duration-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
          >
